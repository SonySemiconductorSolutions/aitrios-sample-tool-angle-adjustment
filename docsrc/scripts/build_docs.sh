...
rm -rf about-output apidocs-output app-setup-guide-azure-output user-guide-output
...
rm -rf about-output apidocs-output app-setup-guide-azure-output app-setup-guide-codespaces-output user-guide-output
