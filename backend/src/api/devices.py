...
STATUS_API_EXPECTED_PARAMS = {"customer_id", "facility_name", "prefecture", "municipality"}
...
def get_device_connection_status():
    ...
    devices, count = build_device_query(db, customer_id=customer_id, parameters=query)
